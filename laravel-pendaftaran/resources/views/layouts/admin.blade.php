...
<head>
    ...
    <title>{{ config('Admin Pendaftaran', 'Admin Pendaftaran') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Pendaftar -->
        <li class="nav-item {{ Nav::isRoute('pendaftar.index') }}">
            <a class="nav-link" href="{{ route('pendaftar.index') }}">
                <i class="fas fa-fw fa-list"></i>
                <span>{{ __('Pendaftar') }}</span>
            </a>
        </li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('SIap untuk Logout?') }}</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">Pilih "Logout" jika anda ingin mengakhiri sesiion ini !</div>
