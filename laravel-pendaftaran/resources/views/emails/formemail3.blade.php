...
<head>
  ...
  <title>{{ config('Data Lengkap', 'Data Lengkap') }}</title>
          ...
          <div class="row">
            <div class="col">
                ...
                <div hidden class="form-group">
                  <label for="id">ID<span class="small text-danger">*</span></label>
                  <input disabled type="text" class="form-control @error('id') is-invalid @enderror" name="id" id="id" autocomplete="off" value="{{ old('id') ?? $pendaftar->id }}">
                  @error('id')
                ...
                <div class="form-group">
                  ...
                  <input disabled type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" autocomplete="off" value="{{ old('kode') ?? $pendaftar->kode }}">
                  @error('kode')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control @error('foto') is-invalid @enderror" name="foto" id="foto" autocomplete="off" value="{{ old('foto') ?? $pendaftar->foto }}">
                  @error('foto')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" id="nik" autocomplete="off" value="{{ old('nik') ?? $pendaftar->nik }}">
                  @error('nik')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn" id="nisn" autocomplete="off" value="{{ old('nisn') ?? $pendaftar->nisn }}">
                  @error('nisn')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input disabled type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" autocomplete="off" value="{{ old('nama') ?? $pendaftar->nama }}">
                  @error('nama')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('tempatlahir') is-invalid @enderror" name="tempatlahir" id="tempatlahir" autocomplete="off" value="{{ old('tempatlahir') ?? $pendaftar->tempatlahir }}">
                  @error('tempatlahir')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control @error('tgllahir') is-invalid @enderror" name="tgllahir" id="tgllahir" autocomplete="off" value="{{ old('tgllahir') ?? $pendaftar->tgllahir }}">
                  @error('tgllahir')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" autocomplete="off" value="{{ old('alamat') ?? $pendaftar->alamat }}">
                  @error('tgllahir')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control @error('jeniskelamin') is-invalid @enderror" id="jeniskelamin" name="jeniskelamin" aria-label="Default select example">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control @error('agama') is-invalid @enderror" id="agama" name="agama" aria-label="Default select example">
                ...
                <div class="form-group">
                  ...
                  <input disabled type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="email" autocomplete="off" value="{{ old('email') ?? $pendaftar->email }}">
                  @error('email')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('sekolahasal') is-invalid @enderror" name="sekolahasal" id="sekolahasal" autocomplete="off" value="{{ old('sekolahasal') ?? $pendaftar->sekolahasal }}">
                  @error('sekolahasal')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input disabled type="text" class="form-control @error('telp') is-invalid @enderror" name="telp" id="telp" autocomplete="off" value="{{ old('telp') ?? $pendaftar->telp }}">
                  @error('telp')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
