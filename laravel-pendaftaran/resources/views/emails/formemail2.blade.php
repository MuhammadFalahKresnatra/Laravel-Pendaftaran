          ...
          <div class="row">
            <div class="col">
                ...
                <div class="form-group">
                  <label for="kode">No. Registrasi<span class="small text-danger">*</span></label>
                  <input class="form-control" type="text" name="kode" placeholder="Masukkan No. registrasi yang anda dapatkan dari email.">
                  @error('kode')
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="email" placeholder="Pastikan email anda sama dengan yang sebelumnya">
                  @error('email')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="telp" placeholder="Masukkan No. telepon anda">
                  @error('telp')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
